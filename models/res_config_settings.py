...
class ResConfigSettings(models.TransientModel):
    ...
    #module_google_drive = fields.Boolean(string='Integracion con google drive')
    ...
    def _compute_drive_uri(self):
        ...
        #google_drive_uri = self.env['google.service']._get_google_tokens('drive', scope=self.env['google.drive.config'].get_google_scope())
        for config in self:
